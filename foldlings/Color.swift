...
class Color:UIColor{
    ...
    class func bluePaperColor() -> UIColor{
        return UIColor(red: 101/255.0, green: 115/255.0, blue: 191/255.0, alpha: 0.5)
    }
    class func greenPaperColor() -> UIColor{
        return UIColor(red: 138/255.0, green: 191/255.0, blue: 136/255.0, alpha: 0.5)
    }
    class func purplePaperColor() -> UIColor{
        return UIColor(red: 171/255.0, green: 99/255.0, blue: 187/255.0, alpha: 0.5)
    }
    class func yellowPaperColor() -> UIColor{
        return UIColor(red: 217/255.0, green: 195/255.0, blue: 84/255.0, alpha: 0.5)
    }
    class func orangePaperColor() -> UIColor{
        return UIColor(red: 242/255.0, green: 132/255.0, blue: 92/255.0, alpha: 0.5)
    }
    class func redPaperColor() -> UIColor{
        return UIColor(red: 217/255.0, green: 81/255.0, blue: 106/255.0, alpha: 0.5)
    }
    ...
    class func shaded(color:UIColor) -> UIColor{
        ...
        return UIColor(hue: colorasHSV.hue, saturation: colorasHSV.sat, brightness: newVal, alpha: colorasHSV.alpha)
    }
