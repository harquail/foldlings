    ...
    func pathSplitByPointsNew(path:UIBezierPath,breakers:[CGPoint]) ->[UIBezierPath]{
        ...
        for var i = 0; i < Int(path.elementCount()); i++ {
            ...
            case kCGPathElementAddCurveToPoint.value :
                ...
                let midPoint = CGPointMake(bezierInterpolation(0.5, prevPoint.x, points[0].x, points[1].x, points[2].x), bezierInterpolation(0.5, prevPoint.y, points[0].y, points[1].y, points[2].y));
